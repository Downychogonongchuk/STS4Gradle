...
public class MailService {
	...
	public void createCode() {
		...
		switch (index) {
			case 0:  // 대문자
				key.append((char)(random.nextInt(26) + 97)); // 97 : A아스키 코드 , 0+97 = A 
				break;
			case 1:  // 소문자
	...
	public MimeMessage createEmailForm(String email)
		...
		String setFrom = "renounce774@naver.com"; // mail setting에 설정한 메일
	...
	//Thymeleaf 를 이용한 context(HTML, 메일 화면)를 설정하는 메소드
